...
lrsim(kMax = 1, criticalValues = 1.96,  
      ...
      maxNumberOfIterations = 1000, seed = 12345)
```
The simulated power is about 94% for design 1, and 85% for design 2. Neither is close to the target 90% power.  
